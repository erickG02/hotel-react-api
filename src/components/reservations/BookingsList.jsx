...
export default function BookingsList() {
  ...
  useEffect(() => {
    ...
    const fetchOptions = async () => {
      try {
        ...
        alert("Error cargando opciones para el formulario.");
      }
    };
  ...
  const handleCreateReservation = async (e) => {
    ...
    try {
      ...
      console.error("Error al crear la reservación:", err.response?.data || err.message);
      alert("Error al crear la reservación: " + (err.response?.data?.message || err.message));
    }
  };
